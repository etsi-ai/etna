...
class Model:
    ...
    def train(self, epochs: int = 100, lr: float = 0.01, weight_decay: float = 0.0, optimizer: str = 'sgd', validation_split: float = 0.2, batch_size: int = 0):
        """
        Train the model.
        ...
        Args:
            ...
            batch_size: Batch size for training (default: 0 means full batch).
        """
